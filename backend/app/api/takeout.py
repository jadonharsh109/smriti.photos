...
library is a separate decision, taken through the ordinary "add a folder" path
like any other folder, which is why nothing here registers a root or reports on
