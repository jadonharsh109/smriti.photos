...
from .api import (albums, cleanup, dupes, events, jobs, kinds, locked, media, moments, motion,
                  people, places, roots, search, system, takeout, timeline, volumes)
...
for r in (system, volumes, roots, jobs, timeline, media, people, places, albums, events,
          dupes, locked, kinds, cleanup, takeout, motion, search, moments):
